	 ...
	 login_btn.addActionListener(new ActionListener()
	 {
	  ...
	  public void actionPerformed(ActionEvent event)
	  {
		  if (stuid.getText().equals(""))
				  {
			  JOptionPane.showMessageDialog(null, "请输入有效值！", "查找",JOptionPane.INFORMATION_MESSAGE);
				   //声明提示
				 
				  } else 
				  {
					  int id=Integer.parseInt(stuid.getText());
					  String out=(String) studen.cha(id);
					  JOptionPane.showMessageDialog(null, out, "查找",JOptionPane.INFORMATION_MESSAGE);
